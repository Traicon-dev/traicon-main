...
const PrivacyPolicy = () => {
    ...
    return(
        <>
              <Helmet>
              <title>TRAICON | PRIVACY POLICY</title>
              <meta name="description" content="Learn about our policies on collecting, using, and sharing your personal data, and the choices you have when using our services." />
            </Helmet>
         <PrivacySection>
            <PrivacyTop>
                <ContactPatch />
