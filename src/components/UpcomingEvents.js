...
import frscomBg from "../images/events/frs/fintech_comb_bg.jpg"
import frscomLogo from "../images/events/frs/frs_comb_logo.png"
  ...
  <g>
    ...
    />
            ...
            >
                  <div className="event-slide-box">
              <div className="event-logo">
                  <img src={rmsIndLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
...
>
  ...
  <g>
    ...
    />
              ...
              <div className="event-slide-name">Datacentre And Cloud Innovation Series </div>
              <div className="eventdate-place">25<sup>th</sup> MARCH 2025, Australia</div>
            </div>
            ...
            >
                  <div className="event-slide-box">
              <div className="event-logo">
                  <img src={dcisSaLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
...
<div className="eweb-link">
  <a href="https://dcis.traiconevents.com/southafrica/" target="_blank" rel="noopener noreferrer">VIEW EVENT</a>
</div>
              <div className="event-slide-patch">
              <svg
  xmlns="http://www.w3.org/2000/svg"
...
>
  ...
  <g>
    ...
    />
                ...
                <img src={dcisSaBg} alt="dcis" />
              </div>
              <div className="event-slide-name">Datacentre And Cloud Innovation Series </div>
              <div className="eventdate-place"> 10<sup>th</sup> April 2025, JOHANNESBURG</div>
            </div>
            ...
            >
              <div className="event-slide-box">
                <div className="event-logo el2">
                  <img src={ogtsLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
...
>
  ...
  <g>
    ...
    />
                ...
                <img src={ogtsBg} alt="Ogts" />
              </div>
              <div className="event-slide-name">Oil And Gas Technology Summit</div>
              <div className="eventdate-place">22<sup>nd</sup> - 23<sup>rd</sup> APRIL 2025,Saudi Arabia</div>
            </div>
            ...
            >
              <div className="event-slide-box">
                <div className="event-logo el2">
                  <img src={frsphLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
  ...
  <g>
    ...
    />
            ...
            >
              <div className="event-slide-box">
                <div className="event-logo el2">
                  <img src={frscomLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
...
>
  ...
  <g>
    ...
    />
                ...
                <img src={frscomBg} alt="Ogts" />
              </div>
              <div className="event-slide-name">Fintech Revolution Summit</div>
              <div className="eventdate-place"> 09<sup>th</sup> MAY 2025,Cambodia</div>
            </div>
            ...
            >
              <div className="event-slide-box">
                <div className="event-logo">
                  <img src={crsIndLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
...
>
  ...
  <g>
    ...
    />
              ...
              <div className="eventdate-place"> 16<sup>th</sup> MAY 2025, INDIA</div>
            </div>
            ...
            >
                  <div className="event-slide-box">
              <div className="event-logo">
                  <img src={whrphLogo} alt=""  className="eventLogo"/>
                </div>
                <div className="event-slide-overlay">
